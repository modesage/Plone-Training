...
DEPLOY_ENV=prod
DEPLOY_HOST=training.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=training-example-com
```
...
You need either a Ubuntu or Debian based system for training.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/training.example.com.yml` to the remote server with:
