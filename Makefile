...
stack-start:  ## Local Stack: Start Services
	...
	@echo "Now visit: http://training.localhost"
...
acceptance-frontend-image-build:
	...
	@docker build frontend -t collective/training-frontend:acceptance -f frontend/Dockerfile --build-arg VOLTO_VERSION=$(VOLTO_VERSION)

.PHONY: acceptance-backend-image-build
acceptance-backend-image-build:
	@echo "Build acceptance backend image"
	@docker build backend -t collective/training-backend:acceptance -f backend/Dockerfile.acceptance --build-arg PLONE_VERSION=$(PLONE_VERSION)
